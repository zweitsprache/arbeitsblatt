                    ...
                    >
                      {visibleBlocks.map((block) => (
                        <div
                          ...
                          {...(block.type === "numbered-items" && resolvedProfile.blockGap ? { style: { marginTop: resolvedProfile.blockGap, marginBottom: resolvedProfile.blockGap } } : {})}
                        >
